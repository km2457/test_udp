        ...
        try:
            ...
            while True:
                ...
                if '0x4' in data_cmdid_array:
                    print('for 0x4')
                    print(answer=self.create_answer(select_header, self.data_pick_cmdid(other_data,type=2)))
...
#t1 = threading.Thread(target=u.send_msg,args=("select",'118.25.225.194',5577))
#t1.start()
